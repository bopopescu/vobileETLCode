...
def getMinDatePara(table_name, date_para, db = "VIACOM_DASHBOARD"):
...
if __name__ == "__main__":
    ...
    vt_TitleBased_SQL = """
        ...
        select 
          ...
          from tracker2.matchedVideo as a, tracker2.metaExtraInfo as b , mddb.trackingWebsite as c, tracker2.matchedFileItem d
          where a.trackingMeta_id = b.meta_id
            and a.trackingWebsite_id = c.id
            and b.company_id = 14
            and a.company_id = 14
