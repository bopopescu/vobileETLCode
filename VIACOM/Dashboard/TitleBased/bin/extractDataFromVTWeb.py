...
log_file = '/Job/VIACOM/Dashboard/TitleBased/log/extractDataFromVTWeb.log'
...
def dataTo_matchedVideoSequence():
    ...
    get_data_arch_sql = """
        select id, company_id from archTracker2.matchedVideo where company_id = 14 and created_at >= "2015-03-01"
    """
    ...
    """
    dataToTarget(data, "tracker2", insert_sql)
