...
logger = logging.getLogger("titleBased_CMS")
logger.setLevel(logging.DEBUG)
log_file = '/Job/VIACOM/Dashboard/TitleBased/log/titleBased_CMS.log'
...
if not os.path.exists(cfg_file):
	...
	sendToMe(subject = "titleBased_CMS ERROR", body = "config file not exists")
	sys.exit(0)
#################################################################################################################################
...
#################################################################################################################################
sendToMe(subject = "titleBased_CMS start", body = "aggregate data from DM_VIACOM.SelfService_Aggregate_ByNoticedDate (CMS data)  start")
...
sendToMe(subject = "titleBased_CMS End", body = "aggregate data from DM_VIACOM.SelfService_Aggregate_ByNoticedDate (CMS data) to  TitleBased1 end")
