...
logger = logging.getLogger("titleBased_matchedVideoViewCountCompletio")
logger.setLevel(logging.DEBUG)
log_file = '/Job/VIACOM/Dashboard/TitleBased/log/titleBased_matchedVideoViewCountCompletion.log'
...
if not os.path.exists(cfg_file):
	...
	sendToMe(subject = "titleBased_matchedVideoViewCountCompletio ERROR", body = "config file not exists")
	sys.exit(0)
#################################################################################################################################
