...
source /etc/profile
bash /root/data-integration/kitchen.sh -file=/Job/VIACOM/SiteDetail_Monthly_mongo/SDM_Link_Files/SiteDetail_Monthly_mongo_v1.kjb

#mysql_conf_123="-h54.67.114.123 -ukettle -pkettle DM_VIACOM"
mysql_conf_114="-h192.168.110.114 -ukettle -pk3UTLe DM_VIACOM"

jobName=SiteDetail_Monthly_mongo_v1
