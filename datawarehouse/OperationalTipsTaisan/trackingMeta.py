...
def upload_to_gs(db):
	...
	load_bigquery = "bq load --skip_leading_rows=1 --field_delimiter='\t' --quote='' OperationalTipsTaisan.trackingMeta gs://vobile-data-analysis/OperationalTipsTaisan/trackingMeta/%s" %f 
	os.system(cmd_csv)
