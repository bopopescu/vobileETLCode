...
def upload_to_gs(db):
	...
	load_bigquery = "bq load --skip_leading_rows=1 --field_delimiter='\t' --quote='' InteractiveDashboard.matchedVideoTest gs://vobile-data-analysis/InteractiveDashboard/matchedVideo/%s" %f 
	os.system(cmd_csv)
