...
def upload_to_gs():
	...
	f = "trackingWebsite.csv"
        SQL = """select * from trackingWebsite""" 
	...
	load_bigquery = "bq load --skip_leading_rows=1 --field_delimiter='\t' --quote='' OperationalTipsTaisan.trackingWebsite gs://vobile-data-analysis/OperationalTipsTaisan/trackingMeta/%s" %f 
	os.system(cmd_csv)
