...
def upload_to_gs():
	...
	f = "trackingMeta_keyword.csv"
        SQL = """select * from trackingMeta_keyword""" 
	...
	print cmd_csv
        create_table = "bq mk OperationalTipsTaisan.trackingMeta_keyword trackingMeta_id:integer,keyword_id:integer,created_at:timestamp"
	cmd_upload = "gsutil cp %s gs://vobile-data-analysis/OperationalTipsTaisan/trackingMeta" %f
	load_bigquery = "bq load --skip_leading_rows=1 --field_delimiter='\t' --quote='' OperationalTipsTaisan.trackingMeta_keyword gs://vobile-data-analysis/OperationalTipsTaisan/trackingMeta/%s" %f 
