...
def upload_to_gs(db):
	...
	f = "trackingMeta_trackingWebsite.csv"
        SQL = """select * from trackingMeta_trackingWebsite""" 
	...
	print cmd_csv
	cmd_upload = "gsutil cp %s gs://vobile-data-analysis/OperationalTipsTaisan/trackingMeta_trackingWebsite" %f
	load_bigquery = "bq load --skip_leading_rows=1 --field_delimiter='\t' --quote='' OperationalTipsTaisan.trackingMeta_trackingWebsite gs://vobile-data-analysis/OperationalTipsTaisan/trackingMeta_trackingWebsite/%s" %f 
	os.system(cmd_csv)
