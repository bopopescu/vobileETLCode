...
get_all = "select * from video_trackingMetaFinished"
print get_all
...
wb = Workbook()
ws = wb.worksheets[0]
ws.title = 'video_trackingMetaFinished'
#ws.column_dimensions["A"].width = 35.0
ew = ExcelWriter(workbook = wb)

file_name = r'/Job/datawarehouse/opertaion/mailsender/data/video_trackingMetaFinished.xlsx'
