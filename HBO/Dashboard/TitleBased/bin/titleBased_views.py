...
log_file = '/Job/HBO/Dashboard/TitleBased/log/titleBased_views.log'
...
#--------------------------------------------------------------------------------------------------------------------------------
logger.info(" aggregate data from DM_HBO.SelfService_Aggregate_ByNoticedDate, extract reportedViews start")
sendToMe(subject = "titleBased_views start", body = "aggregate data from DM_HBO.SelfService_Aggregate_ByNoticedDate, extract reportedViews start")
...
try:
	...
	aggregate_reportedViews_SQL = """
		...
		from DM_HBO.SelfService_Aggregate_ByNoticedDate as a, TitleBasedTrackingWebsite as b
...
logger.info(" aggregate data from DM_HBO.SelfService_Aggregate_ByNoticedDate to  TitleBased1 end")
sendToMe(subject = "titleBased_views End", body = "aggregate data from DM_HBO.SelfService_Aggregate_ByNoticedDate(views) to  TitleBased1 end")
